...
|---|---|---|---|
|stable (v2.0.4)|![7.2+](https://img.shields.io/badge/php-%5E7.2-blue.svg?style=flat-square)|[![Build Status](https://img.shields.io/travis/lavary/crunz/v2.0.4.svg?style=flat-square)](https://travis-ci.org/lavary/crunz)|*Tag build not supported*
