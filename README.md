...
|---|---|---|
|stable (v1.7.3)|[![Build Status](https://img.shields.io/travis/lavary/crunz/v1.7.3.svg?style=flat-square)](https://travis-ci.org/lavary/crunz)|*Tag build not supported*
